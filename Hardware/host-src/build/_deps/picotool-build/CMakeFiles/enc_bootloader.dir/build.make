...
CMakeFiles/enc_bootloader-complete: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install
	...
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/CMakeFiles/enc_bootloader-complete
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-done
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
	cd /d Z:\Code\Github\Ounce\Hardware\host-src\build\_deps\picotool-build\enc_bootloader && $(MAKE)
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
	cd /d Z:\Code\Github\Ounce\Hardware\host-src\build\_deps\picotool-build\enc_bootloader && "C:\Program Files\CMake\bin\cmake.exe" -DCMAKE_MAKE_PROGRAM:FILEPATH=C:/MinGW/bin/mingw32-make.exe -DPICO_SDK_PATH:FILEPATH=Z:/Code/Github/Ounce/Hardware/pico-sdk -DUSE_PRECOMPILED:BOOL=true -DUSE_MBEDTLS=0 -DPICO_DEBUG_INFO_IN_RELEASE=OFF "-GMinGW Makefiles" -S Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-src/enc_bootloader -B Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader
	cd /d Z:\Code\Github\Ounce\Hardware\host-src\build\_deps\picotool-build\enc_bootloader && "C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
	...
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build
	cd /d Z:\Code\Github\Ounce\Hardware\host-src\build\_deps\picotool-build\enc_bootloader && "C:\Program Files\CMake\bin\cmake.exe" -E echo_append

enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir:
	"C:\Program Files\CMake\bin\cmake.exe" -Dcfgdir= -P Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/tmp/enc_bootloader-mkdirs.cmake
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
	"C:\Program Files\CMake\bin\cmake.exe" -E echo_append
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
	"C:\Program Files\CMake\bin\cmake.exe" -E echo_append
	"C:\Program Files\CMake\bin\cmake.exe" -E touch Z:/Code/Github/Ounce/Hardware/host-src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
