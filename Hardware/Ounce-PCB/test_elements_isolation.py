...
pico_clean = convert_to_kicad7_lib_symbol(pico)
picow_clean = convert_to_kicad7_lib_symbol(picow)

symbols_info = [
    ('U1', 'RaspberryPi_Pico_W', 'RaspberryPi_Pico_W', 50.8, 63.5),
    ('U2', 'RaspberryPi_Pico', 'RaspberryPi_Pico', 114.3, 63.5),
    ('U3', 'RaspberryPi_Pico', 'RaspberryPi_Pico', 177.8, 63.5),
    ('U4', 'RaspberryPi_Pico', 'RaspberryPi_Pico', 241.3, 63.5),
    ('U5', 'RaspberryPi_Pico', 'RaspberryPi_Pico', 304.8, 63.5),
]
...
print("Clean short lib_id matching lib_symbols exit code:", res.returncode)
