...
# Replace ONLY top-level symbol name tag
pico_lib = re.sub(r'^\(symbol "RaspberryPi_Pico"', '(symbol "MCU_Module_RaspberryPi_Pico:RaspberryPi_Pico"', pico)
if '(in_bom' not in pico_lib.split('\n')[0]:
    pico_lib = pico_lib.replace('(symbol "MCU_Module_RaspberryPi_Pico:RaspberryPi_Pico"', '(symbol "MCU_Module_RaspberryPi_Pico:RaspberryPi_Pico" (in_bom yes) (on_board yes)')
...
symbols_info = [
    ('U1', 'MCU_Module_RaspberryPi_Pico:RaspberryPi_Pico', 'RaspberryPi_Pico_W', 50.8, 63.5),
...
print("Unprefixed sub-symbols test exit code:", res.returncode)
